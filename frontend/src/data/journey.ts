...
export const journey: JourneyData = {
  ...
  chapters: [
    ...
    },
    {
      ...
      focus: '50% 50%',
      media: {
        video: '/videos/plane-takeoff-wide.mp4',
        videoPortrait: '/videos/plane-takeoff-portrait.mp4',
        videoLow: '/videos/plane-takeoff-wide-low.mp4',
        videoPortraitLow: '/videos/plane-takeoff-portrait-low.mp4',
        poster: '/posters/plane-takeoff.jpg',
        crop: 'auto',
      },
      status: 'complete',
    },
